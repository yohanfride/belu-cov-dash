                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body b-b">
                            <h4>Form Tambah Tes Covid-19</h4>
                            <?php if($error){ ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="faskes" placeholder="Faskes Tes"  name="faskes" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="inputPhone" class="col-form-label">Tanggal Tes</label>
                                        <div class="input-group focused">
                                            <input type="text" class="date-time-picker form-control" data-options="{&quot;timepicker&quot;:false, &quot;format&quot;:&quot;Y-m-d&quot;}" name="tgl_tes" placeholder="Tahun - Bulan - Tanggal (yyyy-mm-dd)" value="<?= date("Y-m-d"); ?>" required>
                                            <span class="input-group-append">
                                                <span class="input-group-text add-on white">
                                                    <i class="icon-calendar"></i>
                                                </span>
